...
## v4 - שני מסלולי בדיקה
- בדיקה אנונימית: ללא שם/ת"ז/טלפון/חתימה.
- בדיקת אמת: פרטים מזהים + תאריך הנפקת ת"ז + חתימה + הסכמות, ולאחר מכן נתונים אמיתיים.
- ב-MVP אין עדיין חיבור אוטומטי למסלקה. פרטים מזהים אינם נשמרים ב-localStorage.
